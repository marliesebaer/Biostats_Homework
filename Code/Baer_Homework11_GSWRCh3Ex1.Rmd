...
filter(DF,Fruit<=80)
#OR: in which rows is it true that fruit is >60 or fruit is <20? it will return all those rows
filter(DF,Fruit>80|Fruit<20)
#AND: both conditions must be true. this will return rows where it is true that both conditions (from 2 variables) are met
