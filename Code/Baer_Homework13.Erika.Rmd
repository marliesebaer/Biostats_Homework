...
```{r}
slice(DF,leaf_units==inches)
```

literally why lord why. Ok I try again. I am going to manually check which ones have inches and just use c()
...
```{r}
English<-data.frame(slice(DF,c(1:5)))
```
...
LET'S MAKE SURE YOU CAN DO THIS. BE SURE TO TAKE A LOOK AT THE KEY. ALSO, I'M GOING TO MAKE A GENERAL CLASS SUGGESTION WHICH IS THAT YOU PUT A FINAL VERSION OF YOUR FILE THAT HAS THE CODE THAT WORKS AND ONLY THAT CODE SO THAT YOU HAVE A RECORD OF HOW THINGS CAN BE DONE.
